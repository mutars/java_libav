package com.mutar.libav.bridge.avformat;
...
import com.mutar.libav.bridge.avcodec.AVCodecParserContext;
import com.mutar.libav.bridge.avcodec.AVPacket;
import com.mutar.libav.bridge.avcodec.AvcodecLibrary.AVCodecID;
import com.mutar.libav.bridge.avcodec.AvcodecLibrary.AVPacketSideDataType;
import com.mutar.libav.bridge.avdevice.AvdeviceLibrary.AVDictionary;
import com.mutar.libav.bridge.avutil.AVBPrint;
 ...
 */
@Library(value = "avformat", dependencies = {"avcodec"})
...
public class AvformatLibrary {
     ...
     * enum values<br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:28</i>
     */
     ...
     * @}<br>
     * enum values<br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:149</i>
     */
     ...
     * enum values<br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:319</i>
     */
     ...
     */
    /** <i>native declaration : ffmpeg_build/include/libavformat/version.h</i> */
    public static final int LIBAVFORMAT_VERSION_MAJOR = (int)57;
    /** <i>native declaration : ffmpeg_build/include/libavformat/version.h</i> */
    public static final int LIBAVFORMAT_VERSION_MINOR = (int)8;
    /** <i>native declaration : ffmpeg_build/include/libavformat/version.h</i> */
    public static final int LIBAVFORMAT_VERSION_MICRO = (int)102;
    /** <i>native declaration : ffmpeg_build/include/libavformat/version.h</i> */
    public static final int LIBAVFORMAT_VERSION_INT = (int)((57) << 16 | (8) << 8 | (102));
    /**
     * define<br>
     * Conversion Error : 57.8.<br>
     * SKIPPED:<br>
     * <i>native declaration : ffmpeg_build/include/libavformat/version.h:0</i><br>
     * 57.8.
     */
    /** <i>native declaration : ffmpeg_build/include/libavformat/version.h</i> */
    public static final int LIBAVFORMAT_BUILD = (int)((57) << 16 | (8) << 8 | (102));
    /** <i>native declaration : ffmpeg_build/include/libavformat/version.h</i> */
    ...
    /** <i>native declaration : ffmpeg_build/include/libavformat/avio.h</i> */
    ...
    /** <i>native declaration : ffmpeg_build/include/libavformat/avformat.h</i> */
    ...
    /** <i>native declaration : ffmpeg_build/include/libavformat/avio.h:494</i> */
    ...
    /** <i>native declaration : ffmpeg_build/include/libavformat/avio.h:495</i> */
    ...
    /** <i>native declaration : ffmpeg_build/include/libavformat/avio.h:496</i> */
    ...
    /** <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:306</i> */
    ...
    /** <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:307</i> */
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:110</i>
     */
    public Pointer<Byte > avio_find_protocol_name(Pointer<Byte > url) {
        return (Pointer)Pointer.pointerToAddress(avio_find_protocol_name(Pointer.getPeer(url)), Byte.class);
    }
    @Ptr
    protected native long avio_find_protocol_name(@Ptr long url);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:123</i>
     */
    public int avio_check(Pointer<Byte > url, int flags) {
        return avio_check(Pointer.getPeer(url), flags);
    }
    protected native int avio_check(@Ptr long url, int flags);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:132</i>
     */
    public int avpriv_io_move(Pointer<Byte > url_src, Pointer<Byte > url_dst) {
        return avpriv_io_move(Pointer.getPeer(url_src), Pointer.getPeer(url_dst));
    }
    protected native int avpriv_io_move(@Ptr long url_src, @Ptr long url_dst);
    /**
     * Delete a resource.<br>
     * @param url resource to be deleted.<br>
     * @return >=0 on success or negative on error.<br>
     * Original signature : <code>int avpriv_io_delete(const char*)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:139</i>
     */
    public int avpriv_io_delete(Pointer<Byte > url) {
        return avpriv_io_delete(Pointer.getPeer(url));
    }
    protected native int avpriv_io_delete(@Ptr long url);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:150</i>
     */
    public int avio_open_dir(Pointer<Pointer<AVIODirContext > > s, Pointer<Byte > url, Pointer<Pointer<AVDictionary > > options) {
        return avio_open_dir(Pointer.getPeer(s), Pointer.getPeer(url), Pointer.getPeer(options));
    }
    protected native int avio_open_dir(@Ptr long s, @Ptr long url, @Ptr long options);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:161</i>
     */
    public int avio_read_dir(Pointer<AVIODirContext > s, Pointer<Pointer<AVIODirEntry > > next) {
        return avio_read_dir(Pointer.getPeer(s), Pointer.getPeer(next));
    }
    protected native int avio_read_dir(@Ptr long s, @Ptr long next);
    /**
     * Close directory.<br>
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:170</i>
     */
    public int avio_close_dir(Pointer<Pointer<AVIODirContext > > s) {
        return avio_close_dir(Pointer.getPeer(s));
    }
    protected native int avio_close_dir(@Ptr long s);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:176</i>
     */
    public void avio_free_directory_entry(Pointer<Pointer<AVIODirEntry > > entry) {
        avio_free_directory_entry(Pointer.getPeer(entry));
    }
    protected native void avio_free_directory_entry(@Ptr long entry);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:197</i>
     */
    ...
    @Ptr
    protected native long avio_alloc_context(@Ptr long buffer, int buffer_size, int write_flag, @Ptr long opaque, @Ptr long read_packet, @Ptr long write_packet, @Ptr long seek);
    /**
     * Original signature : <code>void avio_w8(AVIOContext*, int)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:199</i>
     */
    public void avio_w8(Pointer<AVIOContext > s, int b) {
        avio_w8(Pointer.getPeer(s), b);
    }
    protected native void avio_w8(@Ptr long s, int b);
    /**
     * Original signature : <code>void avio_write(AVIOContext*, const unsigned char*, int)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:201</i>
     */
    public void avio_write(Pointer<AVIOContext > s, Pointer<Byte > buf, int size) {
        avio_write(Pointer.getPeer(s), Pointer.getPeer(buf), size);
    }
    protected native void avio_write(@Ptr long s, @Ptr long buf, int size);
    /**
     * Original signature : <code>void avio_wl64(AVIOContext*, uint64_t)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:203</i>
     */
    public void avio_wl64(Pointer<AVIOContext > s, long val) {
        avio_wl64(Pointer.getPeer(s), val);
    }
    protected native void avio_wl64(@Ptr long s, long val);
    /**
     * Original signature : <code>void avio_wb64(AVIOContext*, uint64_t)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:205</i>
     */
    public void avio_wb64(Pointer<AVIOContext > s, long val) {
        avio_wb64(Pointer.getPeer(s), val);
    }
    protected native void avio_wb64(@Ptr long s, long val);
    /**
     * Original signature : <code>void avio_wl32(AVIOContext*, unsigned int)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:207</i>
     */
    public void avio_wl32(Pointer<AVIOContext > s, int val) {
        avio_wl32(Pointer.getPeer(s), val);
    }
    protected native void avio_wl32(@Ptr long s, int val);
    /**
     * Original signature : <code>void avio_wb32(AVIOContext*, unsigned int)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:209</i>
     */
    public void avio_wb32(Pointer<AVIOContext > s, int val) {
        avio_wb32(Pointer.getPeer(s), val);
    }
    protected native void avio_wb32(@Ptr long s, int val);
    /**
     * Original signature : <code>void avio_wl24(AVIOContext*, unsigned int)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:211</i>
     */
    public void avio_wl24(Pointer<AVIOContext > s, int val) {
        avio_wl24(Pointer.getPeer(s), val);
    }
    protected native void avio_wl24(@Ptr long s, int val);
    /**
     * Original signature : <code>void avio_wb24(AVIOContext*, unsigned int)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:213</i>
     */
    public void avio_wb24(Pointer<AVIOContext > s, int val) {
        avio_wb24(Pointer.getPeer(s), val);
    }
    protected native void avio_wb24(@Ptr long s, int val);
    /**
     * Original signature : <code>void avio_wl16(AVIOContext*, unsigned int)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:215</i>
     */
    public void avio_wl16(Pointer<AVIOContext > s, int val) {
        avio_wl16(Pointer.getPeer(s), val);
    }
    protected native void avio_wl16(@Ptr long s, int val);
    /**
     * Original signature : <code>void avio_wb16(AVIOContext*, unsigned int)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:217</i>
     */
    public void avio_wb16(Pointer<AVIOContext > s, int val) {
        avio_wb16(Pointer.getPeer(s), val);
    }
    protected native void avio_wb16(@Ptr long s, int val);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:223</i>
     */
    public int avio_put_str(Pointer<AVIOContext > s, Pointer<Byte > str) {
        return avio_put_str(Pointer.getPeer(s), Pointer.getPeer(str));
    }
    protected native int avio_put_str(@Ptr long s, @Ptr long str);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:231</i>
     */
    public int avio_put_str16le(Pointer<AVIOContext > s, Pointer<Byte > str) {
        return avio_put_str16le(Pointer.getPeer(s), Pointer.getPeer(str));
    }
    protected native int avio_put_str16le(@Ptr long s, @Ptr long str);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:239</i>
     */
    public int avio_put_str16be(Pointer<AVIOContext > s, Pointer<Byte > str) {
        return avio_put_str16be(Pointer.getPeer(s), Pointer.getPeer(str));
    }
    protected native int avio_put_str16be(@Ptr long s, @Ptr long str);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:245</i>
     */
    public long avio_seek(Pointer<AVIOContext > s, long offset, int whence) {
        return avio_seek(Pointer.getPeer(s), offset, whence);
    }
    protected native long avio_seek(@Ptr long s, long offset, int whence);
    /**
     * Skip given number of bytes forward<br>
     * @return new position or AVERROR.<br>
     * Original signature : <code>int64_t avio_skip(AVIOContext*, int64_t)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:251</i>
     */
    public long avio_skip(Pointer<AVIOContext > s, long offset) {
        return avio_skip(Pointer.getPeer(s), offset);
    }
    protected native long avio_skip(@Ptr long s, long offset);
    /**
     * Get the filesize.<br>
     * @return filesize or AVERROR<br>
     * Original signature : <code>int64_t avio_size(AVIOContext*)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:265</i>
     */
    public long avio_size(Pointer<AVIOContext > s) {
        return avio_size(Pointer.getPeer(s));
    }
    protected native long avio_size(@Ptr long s);
    /**
    ...
    protected native int avio_feof(@Ptr long s);
    /**
     * @deprecated use avio_feof()<br>
     * Original signature : <code>int url_feof(AVIOContext*)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:276</i>
     */
    public int url_feof(Pointer<AVIOContext > s) {
        return url_feof(Pointer.getPeer(s));
    }
    protected native int url_feof(@Ptr long s);
    /**
     * @warning currently size is limited<br>
     * Original signature : <code>int avio_printf(AVIOContext*, const char*, null)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:281</i>
     */
    public int avio_printf(Pointer<AVIOContext > s, Pointer<Byte > fmt, Object... varArgs1) {
        return avio_printf(Pointer.getPeer(s), Pointer.getPeer(fmt), varArgs1);
    }
    protected native int avio_printf(@Ptr long s, @Ptr long fmt, Object... varArgs1);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:291</i>
     */
    public void avio_flush(Pointer<AVIOContext > s) {
        avio_flush(Pointer.getPeer(s));
    }
    protected native void avio_flush(@Ptr long s);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:297</i>
     */
    public int avio_read(Pointer<AVIOContext > s, Pointer<Byte > buf, int size) {
        return avio_read(Pointer.getPeer(s), Pointer.getPeer(buf), size);
    }
    protected native int avio_read(@Ptr long s, @Ptr long buf, int size);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:305</i>
     */
    public int avio_r8(Pointer<AVIOContext > s) {
        return avio_r8(Pointer.getPeer(s));
    }
    protected native int avio_r8(@Ptr long s);
    /**
     * Original signature : <code>int avio_rl16(AVIOContext*)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:307</i>
     */
    public int avio_rl16(Pointer<AVIOContext > s) {
        return avio_rl16(Pointer.getPeer(s));
    }
    protected native int avio_rl16(@Ptr long s);
    /**
    ...
    protected native int avio_rl24(@Ptr long s);
    /**
     * Original signature : <code>int avio_rl32(AVIOContext*)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:311</i>
     */
    public int avio_rl32(Pointer<AVIOContext > s) {
        return avio_rl32(Pointer.getPeer(s));
    }
    protected native int avio_rl32(@Ptr long s);
    /**
     * Original signature : <code>uint64_t avio_rl64(AVIOContext*)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:313</i>
     */
    public long avio_rl64(Pointer<AVIOContext > s) {
        return avio_rl64(Pointer.getPeer(s));
    }
    protected native long avio_rl64(@Ptr long s);
    /**
     * Original signature : <code>int avio_rb16(AVIOContext*)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:315</i>
     */
    public int avio_rb16(Pointer<AVIOContext > s) {
        return avio_rb16(Pointer.getPeer(s));
    }
    protected native int avio_rb16(@Ptr long s);
    /**
     * Original signature : <code>int avio_rb24(AVIOContext*)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:317</i>
     */
    public int avio_rb24(Pointer<AVIOContext > s) {
        return avio_rb24(Pointer.getPeer(s));
    }
    protected native int avio_rb24(@Ptr long s);
    /**
     * Original signature : <code>int avio_rb32(AVIOContext*)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:319</i>
     */
    public int avio_rb32(Pointer<AVIOContext > s) {
        return avio_rb32(Pointer.getPeer(s));
    }
    protected native int avio_rb32(@Ptr long s);
    /**
     * Original signature : <code>uint64_t avio_rb64(AVIOContext*)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:321</i>
     */
    public long avio_rb64(Pointer<AVIOContext > s) {
        return avio_rb64(Pointer.getPeer(s));
    }
    protected native long avio_rb64(@Ptr long s);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:334</i>
     */
    public int avio_get_str(Pointer<AVIOContext > pb, int maxlen, Pointer<Byte > buf, int buflen) {
        return avio_get_str(Pointer.getPeer(pb), maxlen, Pointer.getPeer(buf), buflen);
    }
    protected native int avio_get_str(@Ptr long pb, int maxlen, @Ptr long buf, int buflen);
    /**
    ...
    protected native int avio_get_str16le(@Ptr long pb, int maxlen, @Ptr long buf, int buflen);
    /**
     * Original signature : <code>int avio_get_str16be(AVIOContext*, int, char*, int)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:344</i>
     */
    public int avio_get_str16be(Pointer<AVIOContext > pb, int maxlen, Pointer<Byte > buf, int buflen) {
        return avio_get_str16be(Pointer.getPeer(pb), maxlen, Pointer.getPeer(buf), buflen);
    }
    protected native int avio_get_str16be(@Ptr long pb, int maxlen, @Ptr long buf, int buflen);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:359</i>
     */
    ...
    protected native int avio_open(@Ptr long s, @Ptr long url, int flags);
    /**
     * Create and initialize a AVIOContext for accessing the<br>
     * resource indicated by url.<br>
     * @note When the resource indicated by url has been opened in<br>
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:378</i>
     */
    public int avio_open2(Pointer<Pointer<AVIOContext > > s, Pointer<Byte > url, int flags, Pointer<AVIOInterruptCB > int_cb, Pointer<Pointer<AVDictionary > > options) {
        return avio_open2(Pointer.getPeer(s), Pointer.getPeer(url), flags, Pointer.getPeer(int_cb), Pointer.getPeer(options));
    }
    protected native int avio_open2(@Ptr long s, @Ptr long url, int flags, @Ptr long int_cb, @Ptr long options);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:388</i>
     */
    public int avio_close(Pointer<AVIOContext > s) {
        return avio_close(Pointer.getPeer(s));
    }
    protected native int avio_close(@Ptr long s);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:399</i>
     */
    public int avio_closep(Pointer<Pointer<AVIOContext > > s) {
        return avio_closep(Pointer.getPeer(s));
    }
    protected native int avio_closep(@Ptr long s);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:406</i>
     */
    public int avio_open_dyn_buf(Pointer<Pointer<AVIOContext > > s) {
        return avio_open_dyn_buf(Pointer.getPeer(s));
    }
    protected native int avio_open_dyn_buf(@Ptr long s);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:416</i>
     */
    public int avio_close_dyn_buf(Pointer<AVIOContext > s, Pointer<Pointer<Byte > > pbuffer) {
        return avio_close_dyn_buf(Pointer.getPeer(s), Pointer.getPeer(pbuffer));
    }
    protected native int avio_close_dyn_buf(@Ptr long s, @Ptr long pbuffer);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:427</i>
     */
    public Pointer<Byte > avio_enum_protocols(Pointer<Pointer<? > > opaque, int output) {
        return (Pointer)Pointer.pointerToAddress(avio_enum_protocols(Pointer.getPeer(opaque), output), Byte.class);
    }
    @Ptr
    protected native long avio_enum_protocols(@Ptr long opaque, int output);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:435</i>
     */
    public int avio_pause(Pointer<AVIOContext > h, int pause) {
        return avio_pause(Pointer.getPeer(h), pause);
    }
    protected native int avio_pause(@Ptr long h, int pause);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:455</i>
     */
    public long avio_seek_time(Pointer<AVIOContext > h, int stream_index, long timestamp, int flags) {
        return avio_seek_time(Pointer.getPeer(h), stream_index, timestamp, flags);
    }
    protected native long avio_seek_time(@Ptr long h, int stream_index, long timestamp, int flags);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:464</i>
     */
    public int avio_read_to_bprint(Pointer<AVIOContext > h, Pointer<AVBPrint > pb, @Ptr long max_size) {
        return avio_read_to_bprint(Pointer.getPeer(h), Pointer.getPeer(pb), max_size);
    }
    protected native int avio_read_to_bprint(@Ptr long h, @Ptr long pb, @Ptr long max_size);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:473</i>
     */
    public int avio_accept(Pointer<AVIOContext > s, Pointer<Pointer<AVIOContext > > c) {
        return avio_accept(Pointer.getPeer(s), Pointer.getPeer(c));
    }
    protected native int avio_accept(@Ptr long s, @Ptr long c);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avio.h:493</i>
     */
    public int avio_handshake(Pointer<AVIOContext > c) {
        return avio_handshake(Pointer.getPeer(c));
    }
    protected native int avio_handshake(@Ptr long c);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:12</i>
     */
    public int av_get_packet(Pointer<AVIOContext > s, Pointer<AVPacket > pkt, int size) {
        return av_get_packet(Pointer.getPeer(s), Pointer.getPeer(pkt), size);
    }
    protected native int av_get_packet(@Ptr long s, @Ptr long pkt, int size);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:27</i>
     */
    public int av_append_packet(Pointer<AVIOContext > s, Pointer<AVPacket > pkt, int size) {
        return av_append_packet(Pointer.getPeer(s), Pointer.getPeer(pkt), size);
    }
    protected native int av_append_packet(@Ptr long s, @Ptr long pkt, int size);
    /**
     * Original signature : <code>AVRational av_stream_get_r_frame_rate(const AVStream*)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:253</i>
     */
    public AVRational av_stream_get_r_frame_rate(Pointer<AVStream > s) {
        return av_stream_get_r_frame_rate(Pointer.getPeer(s));
    }
    protected native AVRational av_stream_get_r_frame_rate(@Ptr long s);
    /**
     * Original signature : <code>void av_stream_set_r_frame_rate(AVStream*, AVRational)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:255</i>
     */
    public void av_stream_set_r_frame_rate(Pointer<AVStream > s, AVRational r) {
        av_stream_set_r_frame_rate(Pointer.getPeer(s), r);
    }
    protected native void av_stream_set_r_frame_rate(@Ptr long s, AVRational r);
    /**
     * Original signature : <code>AVCodecParserContext* av_stream_get_parser(const AVStream*)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:257</i>
     */
    public Pointer<AVCodecParserContext > av_stream_get_parser(Pointer<AVStream > s) {
        return (Pointer)Pointer.pointerToAddress(av_stream_get_parser(Pointer.getPeer(s)), AVCodecParserContext.class);
    }
    @Ptr
    protected native long av_stream_get_parser(@Ptr long s);
    /**
     * Original signature : <code>char* av_stream_get_recommended_encoder_configuration(const AVStream*)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:259</i>
     */
    public Pointer<Byte > av_stream_get_recommended_encoder_configuration(Pointer<AVStream > s) {
        return (Pointer)Pointer.pointerToAddress(av_stream_get_recommended_encoder_configuration(Pointer.getPeer(s)), Byte.class);
    }
    @Ptr
    protected native long av_stream_get_recommended_encoder_configuration(@Ptr long s);
    /**
     * Original signature : <code>void av_stream_set_recommended_encoder_configuration(AVStream*, char*)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:261</i>
     */
    public void av_stream_set_recommended_encoder_configuration(Pointer<AVStream > s, Pointer<Byte > configuration) {
        av_stream_set_recommended_encoder_configuration(Pointer.getPeer(s), Pointer.getPeer(configuration));
    }
    protected native void av_stream_set_recommended_encoder_configuration(@Ptr long s, @Ptr long configuration);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:267</i>
     */
    public long av_stream_get_end_pts(Pointer<AVStream > st) {
        return av_stream_get_end_pts(Pointer.getPeer(st));
    }
    protected native long av_stream_get_end_pts(@Ptr long st);
    /**
     * Original signature : <code>int av_format_get_probe_score(const AVFormatContext*)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:410</i>
     */
    public int av_format_get_probe_score(Pointer<AVFormatContext > s) {
        return av_format_get_probe_score(Pointer.getPeer(s));
    }
    protected native int av_format_get_probe_score(@Ptr long s);
    /**
     * Original signature : <code>AVCodec* av_format_get_video_codec(const AVFormatContext*)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:412</i>
     */
    public Pointer<AVCodec > av_format_get_video_codec(Pointer<AVFormatContext > s) {
        return (Pointer)Pointer.pointerToAddress(av_format_get_video_codec(Pointer.getPeer(s)), AVCodec.class);
    }
    @Ptr
    protected native long av_format_get_video_codec(@Ptr long s);
    /**
     * Original signature : <code>void av_format_set_video_codec(AVFormatContext*, AVCodec*)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:414</i>
     */
    public void av_format_set_video_codec(Pointer<AVFormatContext > s, Pointer<AVCodec > c) {
        av_format_set_video_codec(Pointer.getPeer(s), Pointer.getPeer(c));
    }
    protected native void av_format_set_video_codec(@Ptr long s, @Ptr long c);
    /**
     * Original signature : <code>AVCodec* av_format_get_audio_codec(const AVFormatContext*)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:416</i>
     */
    public Pointer<AVCodec > av_format_get_audio_codec(Pointer<AVFormatContext > s) {
        return (Pointer)Pointer.pointerToAddress(av_format_get_audio_codec(Pointer.getPeer(s)), AVCodec.class);
    }
    @Ptr
    protected native long av_format_get_audio_codec(@Ptr long s);
    /**
     * Original signature : <code>void av_format_set_audio_codec(AVFormatContext*, AVCodec*)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:418</i>
     */
    public void av_format_set_audio_codec(Pointer<AVFormatContext > s, Pointer<AVCodec > c) {
        av_format_set_audio_codec(Pointer.getPeer(s), Pointer.getPeer(c));
    }
    protected native void av_format_set_audio_codec(@Ptr long s, @Ptr long c);
    /**
     * Original signature : <code>AVCodec* av_format_get_subtitle_codec(const AVFormatContext*)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:420</i>
     */
    public Pointer<AVCodec > av_format_get_subtitle_codec(Pointer<AVFormatContext > s) {
        return (Pointer)Pointer.pointerToAddress(av_format_get_subtitle_codec(Pointer.getPeer(s)), AVCodec.class);
    }
    @Ptr
    protected native long av_format_get_subtitle_codec(@Ptr long s);
    /**
     * Original signature : <code>void av_format_set_subtitle_codec(AVFormatContext*, AVCodec*)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:422</i>
     */
    public void av_format_set_subtitle_codec(Pointer<AVFormatContext > s, Pointer<AVCodec > c) {
        av_format_set_subtitle_codec(Pointer.getPeer(s), Pointer.getPeer(c));
    }
    protected native void av_format_set_subtitle_codec(@Ptr long s, @Ptr long c);
    /**
     * Original signature : <code>AVCodec* av_format_get_data_codec(const AVFormatContext*)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:424</i>
     */
    public Pointer<AVCodec > av_format_get_data_codec(Pointer<AVFormatContext > s) {
        return (Pointer)Pointer.pointerToAddress(av_format_get_data_codec(Pointer.getPeer(s)), AVCodec.class);
    }
    @Ptr
    protected native long av_format_get_data_codec(@Ptr long s);
    /**
     * Original signature : <code>void av_format_set_data_codec(AVFormatContext*, AVCodec*)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:426</i>
     */
    public void av_format_set_data_codec(Pointer<AVFormatContext > s, Pointer<AVCodec > c) {
        av_format_set_data_codec(Pointer.getPeer(s), Pointer.getPeer(c));
    }
    protected native void av_format_set_data_codec(@Ptr long s, @Ptr long c);
    /**
     * Original signature : <code>int av_format_get_metadata_header_padding(const AVFormatContext*)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:428</i>
     */
    public int av_format_get_metadata_header_padding(Pointer<AVFormatContext > s) {
        return av_format_get_metadata_header_padding(Pointer.getPeer(s));
    }
    protected native int av_format_get_metadata_header_padding(@Ptr long s);
    /**
     * Original signature : <code>void av_format_set_metadata_header_padding(AVFormatContext*, int)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:430</i>
     */
    public void av_format_set_metadata_header_padding(Pointer<AVFormatContext > s, int c) {
        av_format_set_metadata_header_padding(Pointer.getPeer(s), c);
    }
    protected native void av_format_set_metadata_header_padding(@Ptr long s, int c);
    /**
     * Original signature : <code>void* av_format_get_opaque(const AVFormatContext*)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:432</i>
     */
    public Pointer<? > av_format_get_opaque(Pointer<AVFormatContext > s) {
        return Pointer.pointerToAddress(av_format_get_opaque(Pointer.getPeer(s)));
    }
    @Ptr
    protected native long av_format_get_opaque(@Ptr long s);
    /**
     * Original signature : <code>void av_format_set_opaque(AVFormatContext*, void*)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:434</i>
     */
    public void av_format_set_opaque(Pointer<AVFormatContext > s, Pointer<? > opaque) {
        av_format_set_opaque(Pointer.getPeer(s), Pointer.getPeer(opaque));
    }
    protected native void av_format_set_opaque(@Ptr long s, @Ptr long opaque);
    /**
     * Original signature : <code>av_format_control_message av_format_get_control_message_cb(const AVFormatContext*)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:436</i>
     */
    public Pointer<AvformatLibrary.av_format_control_message > av_format_get_control_message_cb(Pointer<AVFormatContext > s) {
        return (Pointer)Pointer.pointerToAddress(av_format_get_control_message_cb(Pointer.getPeer(s)), AvformatLibrary.av_format_control_message.class);
    }
    @Ptr
    protected native long av_format_get_control_message_cb(@Ptr long s);
    /**
     * Original signature : <code>void av_format_set_control_message_cb(AVFormatContext*, av_format_control_message)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:438</i>
     */
    public void av_format_set_control_message_cb(Pointer<AVFormatContext > s, Pointer<AvformatLibrary.av_format_control_message > callback) {
        av_format_set_control_message_cb(Pointer.getPeer(s), Pointer.getPeer(callback));
    }
    protected native void av_format_set_control_message_cb(@Ptr long s, @Ptr long callback);
    /**
     * Original signature : <code>AVOpenCallback av_format_get_open_cb(const AVFormatContext*)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:440</i>
     */
    public Pointer<AvformatLibrary.AVOpenCallback > av_format_get_open_cb(Pointer<AVFormatContext > s) {
        return (Pointer)Pointer.pointerToAddress(av_format_get_open_cb(Pointer.getPeer(s)), AvformatLibrary.AVOpenCallback.class);
    }
    @Ptr
    protected native long av_format_get_open_cb(@Ptr long s);
    /**
     * Original signature : <code>void av_format_set_open_cb(AVFormatContext*, AVOpenCallback)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:442</i>
     */
    public void av_format_set_open_cb(Pointer<AVFormatContext > s, Pointer<AvformatLibrary.AVOpenCallback > callback) {
        av_format_set_open_cb(Pointer.getPeer(s), Pointer.getPeer(callback));
    }
    protected native void av_format_set_open_cb(@Ptr long s, @Ptr long callback);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:448</i>
     */
    public void av_format_inject_global_side_data(Pointer<AVFormatContext > s) {
        av_format_inject_global_side_data(Pointer.getPeer(s));
    }
    protected native void av_format_inject_global_side_data(@Ptr long s);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:454</i>
     */
    public IntValuedEnum<AvformatLibrary.AVDurationEstimationMethod > av_fmt_ctx_get_duration_estimation_method(Pointer<AVFormatContext > ctx) {
    ...
    protected native int av_fmt_ctx_get_duration_estimation_method(@Ptr long ctx);
    /**
     * Return the LIBAVFORMAT_VERSION_INT constant.<br>
     * Original signature : <code>int avformat_version()</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:463</i>
     */
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:468</i>
     */
    public Pointer<Byte > avformat_configuration() {
        return (Pointer)Pointer.pointerToAddress(avformat_configuration$2(), Byte.class);
    }
    @Ptr
    @Name("avformat_configuration")
    protected native long avformat_configuration$2();
    /**
     * Return the libavformat license.<br>
     * Original signature : <code>char* avformat_license()</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:473</i>
     */
    public Pointer<Byte > avformat_license() {
        return (Pointer)Pointer.pointerToAddress(avformat_license$2(), Byte.class);
    }
    @Ptr
    @Name("avformat_license")
    protected native long avformat_license$2();
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:482</i>
     */
    public native void av_register_all();
    /**
     * Original signature : <code>void av_register_input_format(AVInputFormat*)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:484</i>
     */
    public void av_register_input_format(Pointer<AVInputFormat > format) {
        av_register_input_format(Pointer.getPeer(format));
    }
    protected native void av_register_input_format(@Ptr long format);
    /**
     * Original signature : <code>void av_register_output_format(AVOutputFormat*)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:486</i>
     */
    public void av_register_output_format(Pointer<AVOutputFormat > format) {
        av_register_output_format(Pointer.getPeer(format));
    }
    protected native void av_register_output_format(@Ptr long format);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:495</i>
     */
    public native int avformat_network_init();
    /**
     * Undo the initialization done by avformat_network_init.<br>
     * Original signature : <code>int avformat_network_deinit()</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:500</i>
     */
    public native int avformat_network_deinit();
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:507</i>
     */
    public Pointer<AVInputFormat > av_iformat_next(Pointer<AVInputFormat > f) {
        return (Pointer)Pointer.pointerToAddress(av_iformat_next(Pointer.getPeer(f)), AVInputFormat.class);
    }
    @Ptr
    protected native long av_iformat_next(@Ptr long f);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:514</i>
     */
    public Pointer<AVOutputFormat > av_oformat_next(Pointer<AVOutputFormat > f) {
        return (Pointer)Pointer.pointerToAddress(av_oformat_next(Pointer.getPeer(f)), AVOutputFormat.class);
    }
    @Ptr
    protected native long av_oformat_next(@Ptr long f);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:521</i>
     */
    ...
    protected native void avformat_free_context(@Ptr long s);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:534</i>
     */
    public Pointer<AVClass > avformat_get_class() {
        return (Pointer)Pointer.pointerToAddress(avformat_get_class$2(), AVClass.class);
    }
    @Ptr
    @Name("avformat_get_class")
    protected native long avformat_get_class$2();
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:550</i>
     */
    ...
    @Ptr
    protected native long avformat_new_stream(@Ptr long s, @Ptr long c);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:559</i>
     */
    public Pointer<Byte > av_stream_get_side_data(Pointer<AVStream > stream, IntValuedEnum<AVPacketSideDataType > type, Pointer<Integer > size) {
    ...
    @Ptr
    protected native long av_stream_get_side_data(@Ptr long stream, int type, @Ptr long size);
    /**
     * Original signature : <code>AVProgram* av_new_program(AVFormatContext*, int)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:561</i>
     */
    public Pointer<AVProgram > av_new_program(Pointer<AVFormatContext > s, int id) {
        return (Pointer)Pointer.pointerToAddress(av_new_program(Pointer.getPeer(s), id), AVProgram.class);
    }
    @Ptr
    protected native long av_new_program(@Ptr long s, int id);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:578</i>
     */
    ...
    protected native int avformat_alloc_output_context2(@Ptr long ctx, @Ptr long oformat, @Ptr long format_name, @Ptr long filename);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:583</i>
     */
    public Pointer<AVInputFormat > av_find_input_format(Pointer<Byte > short_name) {
        return (Pointer)Pointer.pointerToAddress(av_find_input_format(Pointer.getPeer(short_name)), AVInputFormat.class);
    }
    @Ptr
    protected native long av_find_input_format(@Ptr long short_name);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:591</i>
     */
    public Pointer<AVInputFormat > av_probe_input_format(Pointer<AVProbeData > pd, int is_opened) {
        return (Pointer)Pointer.pointerToAddress(av_probe_input_format(Pointer.getPeer(pd), is_opened), AVInputFormat.class);
    }
    @Ptr
    protected native long av_probe_input_format(@Ptr long pd, int is_opened);
    /**
     * Guess the file format.<br>
     * @param pd        data to be probed<br>
     * @param is_opened Whether the file is already opened; determines whether<br>
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:604</i>
     */
    public Pointer<AVInputFormat > av_probe_input_format2(Pointer<AVProbeData > pd, int is_opened, Pointer<Integer > score_max) {
    ...
    @Ptr
    protected native long av_probe_input_format2(@Ptr long pd, int is_opened, @Ptr long score_max);
    /**
     * Guess the file format.<br>
     * @param is_opened Whether the file is already opened; determines whether<br>
     *                  demuxers with or without AVFMT_NOFILE are probed.<br>
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:612</i>
     */
    public Pointer<AVInputFormat > av_probe_input_format3(Pointer<AVProbeData > pd, int is_opened, Pointer<Integer > score_ret) {
    ...
    @Ptr
    protected native long av_probe_input_format3(@Ptr long pd, int is_opened, @Ptr long score_ret);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:629</i>
     */
    public int av_probe_input_buffer2(Pointer<AVIOContext > pb, Pointer<Pointer<AVInputFormat > > fmt, Pointer<Byte > filename, Pointer<? > logctx, int offset, int max_probe_size) {
    ...
    protected native int av_probe_input_buffer2(@Ptr long pb, @Ptr long fmt, @Ptr long filename, @Ptr long logctx, int offset, int max_probe_size);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:634</i>
     */
    public int av_probe_input_buffer(Pointer<AVIOContext > pb, Pointer<Pointer<AVInputFormat > > fmt, Pointer<Byte > filename, Pointer<? > logctx, int offset, int max_probe_size) {
    ...
    protected native int av_probe_input_buffer(@Ptr long pb, @Ptr long fmt, @Ptr long filename, @Ptr long logctx, int offset, int max_probe_size);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:652</i>
     */
    ...
    protected native int avformat_open_input(@Ptr long ps, @Ptr long filename, @Ptr long fmt, @Ptr long options);
    /**
     * Original signature : <code>int av_demuxer_open(AVFormatContext*)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:654</i>
     */
    public int av_demuxer_open(Pointer<AVFormatContext > ic) {
        return av_demuxer_open(Pointer.getPeer(ic));
    }
    protected native int av_demuxer_open(@Ptr long ic);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:674</i>
     */
    ...
    protected native int avformat_find_stream_info(@Ptr long ic, @Ptr long options);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:685</i>
     */
    public Pointer<AVProgram > av_find_program_from_stream(Pointer<AVFormatContext > ic, Pointer<AVProgram > last, int s) {
    ...
    @Ptr
    protected native long av_find_program_from_stream(@Ptr long ic, @Ptr long last, int s);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:710</i>
     */
    ...
    protected native int av_find_best_stream(@Ptr long ic, int type, int wanted_stream_nb, int related_stream, @Ptr long decoder_ret, int flags);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:733</i>
     */
    ...
    protected native int av_read_frame(@Ptr long s, @Ptr long pkt);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:747</i>
     */
    ...
    protected native int av_seek_frame(@Ptr long s, int stream_index, long timestamp, int flags);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:774</i>
     */
    ...
    protected native int avformat_seek_file(@Ptr long s, int stream_index, long min_ts, long ts, long max_ts, int flags);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:789</i>
     */
    public int avformat_flush(Pointer<AVFormatContext > s) {
        return avformat_flush(Pointer.getPeer(s));
    }
    protected native int avformat_flush(@Ptr long s);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:795</i>
     */
    public int av_read_play(Pointer<AVFormatContext > s) {
        return av_read_play(Pointer.getPeer(s));
    }
    protected native int av_read_play(@Ptr long s);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:801</i>
     */
    public int av_read_pause(Pointer<AVFormatContext > s) {
        return av_read_pause(Pointer.getPeer(s));
    }
    protected native int av_read_pause(@Ptr long s);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:807</i>
     */
    public void avformat_close_input(Pointer<Pointer<AVFormatContext > > s) {
        avformat_close_input(Pointer.getPeer(s));
    }
    protected native void avformat_close_input(@Ptr long s);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:821</i>
     */
    ...
    protected native int avformat_write_header(@Ptr long s, @Ptr long options);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:850</i>
     */
    ...
    protected native int av_write_frame(@Ptr long s, @Ptr long pkt);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:881</i>
     */
    ...
    protected native int av_interleaved_write_frame(@Ptr long s, @Ptr long pkt);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:889</i>
     */
    public int av_write_uncoded_frame(Pointer<AVFormatContext > s, int stream_index, Pointer<AVFrame > frame) {
        return av_write_uncoded_frame(Pointer.getPeer(s), stream_index, Pointer.getPeer(frame));
    }
    protected native int av_write_uncoded_frame(@Ptr long s, int stream_index, @Ptr long frame);
    /**
     * Write a uncoded frame to an output media file.<br>
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:903</i>
     */
    public int av_interleaved_write_uncoded_frame(Pointer<AVFormatContext > s, int stream_index, Pointer<AVFrame > frame) {
        return av_interleaved_write_uncoded_frame(Pointer.getPeer(s), stream_index, Pointer.getPeer(frame));
    }
    protected native int av_interleaved_write_uncoded_frame(@Ptr long s, int stream_index, @Ptr long frame);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:910</i>
     */
    public int av_write_uncoded_frame_query(Pointer<AVFormatContext > s, int stream_index) {
        return av_write_uncoded_frame_query(Pointer.getPeer(s), stream_index);
    }
    protected native int av_write_uncoded_frame_query(@Ptr long s, int stream_index);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:919</i>
     */
    public int av_write_trailer(Pointer<AVFormatContext > s) {
        return av_write_trailer(Pointer.getPeer(s));
    }
    protected native int av_write_trailer(@Ptr long s);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:932</i>
     */
    ...
    @Ptr
    protected native long av_guess_format(@Ptr long short_name, @Ptr long filename, @Ptr long mime_type);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:937</i>
     */
    ...
    protected native int av_guess_codec(@Ptr long fmt, @Ptr long short_name, @Ptr long filename, @Ptr long mime_type, int type);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:954</i>
     */
    public int av_get_output_timestamp(Pointer<AVFormatContext > s, int stream, Pointer<Long > dts, Pointer<Long > wall) {
        return av_get_output_timestamp(Pointer.getPeer(s), stream, Pointer.getPeer(dts), Pointer.getPeer(wall));
    }
    protected native int av_get_output_timestamp(@Ptr long s, int stream, @Ptr long dts, @Ptr long wall);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:963</i>
     */
    public void av_hex_dump(Pointer f, Pointer<Byte > buf, int size) {
        av_hex_dump(Pointer.getPeer(f), Pointer.getPeer(buf), size);
    }
    protected native void av_hex_dump(@Ptr long f, @Ptr long buf, int size);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:975</i>
     */
    public void av_hex_dump_log(Pointer<? > avcl, int level, Pointer<Byte > buf, int size) {
        av_hex_dump_log(Pointer.getPeer(avcl), level, Pointer.getPeer(buf), size);
    }
    protected native void av_hex_dump_log(@Ptr long avcl, int level, @Ptr long buf, int size);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:984</i>
     */
    public void av_pkt_dump2(Pointer f, Pointer<AVPacket > pkt, int dump_payload, Pointer<AVStream > st) {
        av_pkt_dump2(Pointer.getPeer(f), Pointer.getPeer(pkt), dump_payload, Pointer.getPeer(st));
    }
    protected native void av_pkt_dump2(@Ptr long f, @Ptr long pkt, int dump_payload, @Ptr long st);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:996</i>
     */
    public void av_pkt_dump_log2(Pointer<? > avcl, int level, Pointer<AVPacket > pkt, int dump_payload, Pointer<AVStream > st) {
        av_pkt_dump_log2(Pointer.getPeer(avcl), level, Pointer.getPeer(pkt), dump_payload, Pointer.getPeer(st));
    }
    protected native void av_pkt_dump_log2(@Ptr long avcl, int level, @Ptr long pkt, int dump_payload, @Ptr long st);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:1005</i>
     */
    public IntValuedEnum<AVCodecID > av_codec_get_id(Pointer<Pointer<AvformatLibrary.AVCodecTag > > tags, int tag) {
        return FlagSet.fromValue(av_codec_get_id(Pointer.getPeer(tags), tag), AVCodecID.class);
    }
    protected native int av_codec_get_id(@Ptr long tags, int tag);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:1014</i>
     */
    public int av_codec_get_tag(Pointer<Pointer<AvformatLibrary.AVCodecTag > > tags, IntValuedEnum<AVCodecID > id) {
        return av_codec_get_tag(Pointer.getPeer(tags), (int)id.value());
    }
    protected native int av_codec_get_tag(@Ptr long tags, int id);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:1024</i>
     */
    public int av_codec_get_tag2(Pointer<Pointer<AvformatLibrary.AVCodecTag > > tags, IntValuedEnum<AVCodecID > id, Pointer<Integer > tag) {
        return av_codec_get_tag2(Pointer.getPeer(tags), (int)id.value(), Pointer.getPeer(tag));
    }
    protected native int av_codec_get_tag2(@Ptr long tags, int id, @Ptr long tag);
    /**
     * Original signature : <code>int av_find_default_stream_index(AVFormatContext*)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:1026</i>
     */
    public int av_find_default_stream_index(Pointer<AVFormatContext > s) {
        return av_find_default_stream_index(Pointer.getPeer(s));
    }
    protected native int av_find_default_stream_index(@Ptr long s);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:1038</i>
     */
    public int av_index_search_timestamp(Pointer<AVStream > st, long timestamp, int flags) {
        return av_index_search_timestamp(Pointer.getPeer(st), timestamp, flags);
    }
    protected native int av_index_search_timestamp(@Ptr long st, long timestamp, int flags);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:1045</i>
     */
    public int av_add_index_entry(Pointer<AVStream > st, long pos, long timestamp, int size, int distance, int flags) {
        return av_add_index_entry(Pointer.getPeer(st), pos, timestamp, size, distance, flags);
    }
    protected native int av_add_index_entry(@Ptr long st, long pos, long timestamp, int size, int distance, int flags);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:1064</i>
     */
    public void av_url_split(Pointer<Byte > proto, int proto_size, Pointer<Byte > authorization, int authorization_size, Pointer<Byte > hostname, int hostname_size, Pointer<Integer > port_ptr, Pointer<Byte > path, int path_size, Pointer<Byte > url) {
    ...
    protected native void av_url_split(@Ptr long proto, int proto_size, @Ptr long authorization, int authorization_size, @Ptr long hostname, int hostname_size, @Ptr long port_ptr, @Ptr long path, int path_size, @Ptr long url);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:1075</i>
     */
    ...
    protected native void av_dump_format(@Ptr long ic, int index, @Ptr long url, int is_output);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:1087</i>
     */
    public int av_get_frame_filename(Pointer<Byte > buf, int buf_size, Pointer<Byte > path, int number) {
        return av_get_frame_filename(Pointer.getPeer(buf), buf_size, Pointer.getPeer(path), number);
    }
    protected native int av_get_frame_filename(@Ptr long buf, int buf_size, @Ptr long path, int number);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:1094</i>
     */
    public int av_filename_number_test(Pointer<Byte > filename) {
        return av_filename_number_test(Pointer.getPeer(filename));
    }
    protected native int av_filename_number_test(@Ptr long filename);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:1111</i>
     */
    public int av_sdp_create(Pointer<Pointer<AVFormatContext > > ac, int n_files, Pointer<Byte > buf, int size) {
        return av_sdp_create(Pointer.getPeer(ac), n_files, Pointer.getPeer(buf), size);
    }
    protected native int av_sdp_create(@Ptr long ac, int n_files, @Ptr long buf, int size);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:1119</i>
     */
    public int av_match_ext(Pointer<Byte > filename, Pointer<Byte > extensions) {
        return av_match_ext(Pointer.getPeer(filename), Pointer.getPeer(extensions));
    }
    protected native int av_match_ext(@Ptr long filename, @Ptr long extensions);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:1129</i>
     */
    public int avformat_query_codec(Pointer<AVOutputFormat > ofmt, IntValuedEnum<AVCodecID > codec_id, int std_compliance) {
        return avformat_query_codec(Pointer.getPeer(ofmt), (int)codec_id.value(), std_compliance);
    }
    protected native int avformat_query_codec(@Ptr long ofmt, int codec_id, int std_compliance);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:1134</i>
     */
    public Pointer<AvformatLibrary.AVCodecTag > avformat_get_riff_video_tags() {
        return (Pointer)Pointer.pointerToAddress(avformat_get_riff_video_tags$2(), AvformatLibrary.AVCodecTag.class);
    }
    @Ptr
    @Name("avformat_get_riff_video_tags")
    protected native long avformat_get_riff_video_tags$2();
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:1139</i>
     */
    public Pointer<AvformatLibrary.AVCodecTag > avformat_get_riff_audio_tags() {
        return (Pointer)Pointer.pointerToAddress(avformat_get_riff_audio_tags$2(), AvformatLibrary.AVCodecTag.class);
    }
    @Ptr
    @Name("avformat_get_riff_audio_tags")
    protected native long avformat_get_riff_audio_tags$2();
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:1144</i>
     */
    public Pointer<AvformatLibrary.AVCodecTag > avformat_get_mov_video_tags() {
        return (Pointer)Pointer.pointerToAddress(avformat_get_mov_video_tags$2(), AvformatLibrary.AVCodecTag.class);
    }
    @Ptr
    @Name("avformat_get_mov_video_tags")
    protected native long avformat_get_mov_video_tags$2();
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:1149</i>
     */
    public Pointer<AvformatLibrary.AVCodecTag > avformat_get_mov_audio_tags() {
        return (Pointer)Pointer.pointerToAddress(avformat_get_mov_audio_tags$2(), AvformatLibrary.AVCodecTag.class);
    }
    @Ptr
    @Name("avformat_get_mov_audio_tags")
    protected native long avformat_get_mov_audio_tags$2();
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:1165</i>
     */
    public AVRational av_guess_sample_aspect_ratio(Pointer<AVFormatContext > format, Pointer<AVStream > stream, Pointer<AVFrame > frame) {
        return av_guess_sample_aspect_ratio(Pointer.getPeer(format), Pointer.getPeer(stream), Pointer.getPeer(frame));
    }
    protected native AVRational av_guess_sample_aspect_ratio(@Ptr long format, @Ptr long stream, @Ptr long frame);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:1174</i>
     */
    public AVRational av_guess_frame_rate(Pointer<AVFormatContext > ctx, Pointer<AVStream > stream, Pointer<AVFrame > frame) {
        return av_guess_frame_rate(Pointer.getPeer(ctx), Pointer.getPeer(stream), Pointer.getPeer(frame));
    }
    protected native AVRational av_guess_frame_rate(@Ptr long ctx, @Ptr long stream, @Ptr long frame);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:1186</i>
     */
    public int avformat_match_stream_specifier(Pointer<AVFormatContext > s, Pointer<AVStream > st, Pointer<Byte > spec) {
        return avformat_match_stream_specifier(Pointer.getPeer(s), Pointer.getPeer(st), Pointer.getPeer(spec));
    }
    protected native int avformat_match_stream_specifier(@Ptr long s, @Ptr long st, @Ptr long spec);
    /**
     * Original signature : <code>int avformat_queue_attached_pictures(AVFormatContext*)</code><br>
     * <i>native declaration : ffmpeg_build/include/libavformat/avformat.h:1188</i>
     */
    public int avformat_queue_attached_pictures(Pointer<AVFormatContext > s) {
        return avformat_queue_attached_pictures(Pointer.getPeer(s));
    }
    protected native int avformat_queue_attached_pictures(@Ptr long s);
    /** Undefined type */
    public static interface FFFrac {
    ...
    /** Undefined type */
    public static interface AVFormatInternal {
