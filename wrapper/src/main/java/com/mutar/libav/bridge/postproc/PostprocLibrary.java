package com.mutar.libav.bridge.postproc;
 ...
 */
@Library(value = "postproc" , dependencies = {"avutil"})
...
public class PostprocLibrary {
     ...
     */
    /** <i>native declaration : ffmpeg_build/include/libpostproc/version.h</i> */
     ...
     * SKIPPED:<br>
     * <i>native declaration : ffmpeg_build/include/libpostproc/version.h:0</i><br>
     * 54.0.
     */
    /** <i>native declaration : ffmpeg_build/include/libpostproc/version.h</i> */
    ...
    /** <i>native declaration : ffmpeg_build/include/libpostproc/postprocess.h</i> */
     ...
     * <i>native declaration : ffmpeg_build/include/libpostproc/postprocess.h:4</i>
     */
    public native int postproc_version();
    /**
     * Return the libpostproc build-time configuration.<br>
     * Original signature : <code>char* postproc_configuration()</code><br>
     * <i>native declaration : ffmpeg_build/include/libpostproc/postprocess.h:9</i>
     */
    public Pointer<Byte > postproc_configuration() {
        return (Pointer)Pointer.pointerToAddress(postproc_configuration$2(), Byte.class);
    }
    @Ptr
    @Name("postproc_configuration")
    protected native long postproc_configuration$2();
    /**
     * Return the libpostproc license.<br>
     * Original signature : <code>char* postproc_license()</code><br>
     * <i>native declaration : ffmpeg_build/include/libpostproc/postprocess.h:14</i>
     */
    public Pointer<Byte > postproc_license() {
        return (Pointer)Pointer.pointerToAddress(postproc_license$2(), Byte.class);
    }
    @Ptr
    @Name("postproc_license")
    protected native long postproc_license$2();
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libpostproc/postprocess.h:5</i>
     */
    public void pp_postprocess(Pointer<Pointer<Byte > > src, Pointer<Integer > srcStride, Pointer<Pointer<Byte > > dst, Pointer<Integer > dstStride, int horizontalSize, int verticalSize, Pointer<Byte > QP_store, int QP_stride, Pointer<? > mode, Pointer<? > ppContext, int pict_type) {
    ...
    protected native void pp_postprocess(@Ptr long src, @Ptr long srcStride, @Ptr long dst, @Ptr long dstStride, int horizontalSize, int verticalSize, @Ptr long QP_store, int QP_stride, @Ptr long mode, @Ptr long ppContext, int pict_type);
    /**
     ...
     * <i>native declaration : ffmpeg_build/include/libpostproc/postprocess.h:12</i>
     */
    public Pointer<? > pp_get_mode_by_name_and_quality(Pointer<Byte > name, int quality) {
        return Pointer.pointerToAddress(pp_get_mode_by_name_and_quality(Pointer.getPeer(name), quality));
    }
    @Ptr
    protected native long pp_get_mode_by_name_and_quality(@Ptr long name, int quality);
    /**
     * Original signature : <code>void pp_free_mode(pp_mode*)</code><br>
     * <i>native declaration : ffmpeg_build/include/libpostproc/postprocess.h:14</i>
     */
    public void pp_free_mode(Pointer<? > mode) {
        pp_free_mode(Pointer.getPeer(mode));
    }
    protected native void pp_free_mode(@Ptr long mode);
    /**
     * Original signature : <code>pp_context* pp_get_context(int, int, int)</code><br>
     * <i>native declaration : ffmpeg_build/include/libpostproc/postprocess.h:16</i>
     */
    public Pointer<? > pp_get_context(int width, int height, int flags) {
        return Pointer.pointerToAddress(pp_get_context$2(width, height, flags));
    }
    @Ptr
    @Name("pp_get_context")
    protected native long pp_get_context$2(int width, int height, int flags);
    /**
     * Original signature : <code>void pp_free_context(pp_context*)</code><br>
     * <i>native declaration : ffmpeg_build/include/libpostproc/postprocess.h:18</i>
     */
    public void pp_free_context(Pointer<? > ppContext) {
        pp_free_context(Pointer.getPeer(ppContext));
    }
    protected native void pp_free_context(@Ptr long ppContext);
    /**
