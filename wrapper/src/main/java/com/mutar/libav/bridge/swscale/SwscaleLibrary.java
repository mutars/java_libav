package com.mutar.libav.bridge.swscale;
...
public class SwscaleLibrary {
	 ...
	 * SKIPPED:<br>
	 * <i>native declaration : ffmpeg_build/include/libswscale/version.h:0</i><br>
	 * 4.0.
	 */
	/** <i>native declaration : ffmpeg_build/include/libswscale/version.h</i> */
	...
	/** <i>native declaration : ffmpeg_build/include/libswscale/swscale.h</i> */
	 ...
	 * <i>native declaration : ffmpeg_build/include/libswscale/swscale.h:6</i>
	 */
	 ...
	 * <i>native declaration : ffmpeg_build/include/libswscale/swscale.h:11</i>
	 */
	public Pointer<Byte > swscale_configuration() {
		return (Pointer)Pointer.pointerToAddress(swscale_configuration$2(), Byte.class);
	}
	@Ptr 
	@Name("swscale_configuration") 
	protected native long swscale_configuration$2();
	/**
	 * Return the libswscale license.<br>
	 * Original signature : <code>char* swscale_license()</code><br>
	 * <i>native declaration : ffmpeg_build/include/libswscale/swscale.h:16</i>
	 */
	public Pointer<Byte > swscale_license() {
		return (Pointer)Pointer.pointerToAddress(swscale_license$2(), Byte.class);
	}
	@Ptr 
	@Name("swscale_license") 
	protected native long swscale_license$2();
	/**
	 ...
	 * <i>native declaration : ffmpeg_build/include/libswscale/swscale.h:24</i>
	 */
	public Pointer<Integer > sws_getCoefficients(int colorspace) {
		return (Pointer)Pointer.pointerToAddress(sws_getCoefficients$2(colorspace), Integer.class);
	}
	@Ptr 
	@Name("sws_getCoefficients") 
	protected native long sws_getCoefficients$2(int colorspace);
	/**
	 ...
	 * <i>native declaration : ffmpeg_build/include/libswscale/swscale.h:45</i>
	 */
	public int sws_isSupportedInput(IntValuedEnum<AVPixelFormat > pix_fmt) {
		return sws_isSupportedInput((int)pix_fmt.value());
	}
	protected native int sws_isSupportedInput(int pix_fmt);
	/**
	 ...
	 * <i>native declaration : ffmpeg_build/include/libswscale/swscale.h:51</i>
	 */
	public int sws_isSupportedOutput(IntValuedEnum<AVPixelFormat > pix_fmt) {
		return sws_isSupportedOutput((int)pix_fmt.value());
	}
	protected native int sws_isSupportedOutput(int pix_fmt);
	/**
	 ...
	 * <i>native declaration : ffmpeg_build/include/libswscale/swscale.h:58</i>
	 */
	public int sws_isSupportedEndiannessConversion(IntValuedEnum<AVPixelFormat > pix_fmt) {
		return sws_isSupportedEndiannessConversion((int)pix_fmt.value());
	}
	protected native int sws_isSupportedEndiannessConversion(int pix_fmt);
	/**
	 ...
	 * <i>native declaration : ffmpeg_build/include/libswscale/swscale.h:65</i>
	 */
	public Pointer<SwscaleLibrary.SwsContext > sws_alloc_context() {
		return (Pointer)Pointer.pointerToAddress(sws_alloc_context$2(), SwscaleLibrary.SwsContext.class);
	}
	@Ptr 
	@Name("sws_alloc_context") 
	protected native long sws_alloc_context$2();
	/**
	 ...
	 * <i>native declaration : ffmpeg_build/include/libswscale/swscale.h:72</i>
	 */
	public int sws_init_context(Pointer<SwscaleLibrary.SwsContext > sws_context, Pointer<SwsFilter > srcFilter, Pointer<SwsFilter > dstFilter) {
		return sws_init_context(Pointer.getPeer(sws_context), Pointer.getPeer(srcFilter), Pointer.getPeer(dstFilter));
	}
	protected native int sws_init_context(@Ptr long sws_context, @Ptr long srcFilter, @Ptr long dstFilter);
	/**
	 ...
	 * <i>native declaration : ffmpeg_build/include/libswscale/swscale.h:78</i>
	 */
	public void sws_freeContext(Pointer<SwscaleLibrary.SwsContext > swsContext) {
		sws_freeContext(Pointer.getPeer(swsContext));
	}
	protected native void sws_freeContext(@Ptr long swsContext);
	/**
	 ...
	 * <i>native declaration : ffmpeg_build/include/libswscale/swscale.h:100</i>
	 */
	public Pointer<SwscaleLibrary.SwsContext > sws_getContext(int srcW, int srcH, IntValuedEnum<AVPixelFormat > srcFormat, int dstW, int dstH, IntValuedEnum<AVPixelFormat > dstFormat, int flags, Pointer<SwsFilter > srcFilter, Pointer<SwsFilter > dstFilter, Pointer<Double > param) {
		return (Pointer)Pointer.pointerToAddress(sws_getContext(srcW, srcH, (int)srcFormat.value(), dstW, dstH, (int)dstFormat.value(), flags, Pointer.getPeer(srcFilter), Pointer.getPeer(dstFilter), Pointer.getPeer(param)), SwscaleLibrary.SwsContext.class);
	}
	@Ptr 
	protected native long sws_getContext(int srcW, int srcH, int srcFormat, int dstW, int dstH, int dstFormat, int flags, @Ptr long srcFilter, @Ptr long dstFilter, @Ptr long param);
	/**
	 ...
	 * <i>native declaration : ffmpeg_build/include/libswscale/swscale.h:126</i>
	 */
	public int sws_scale(Pointer<SwscaleLibrary.SwsContext > c, Pointer<Pointer<Byte > > srcSlice, Pointer<Integer > srcStride, int srcSliceY, int srcSliceH, Pointer<Pointer<Byte > > dst, Pointer<Integer > dstStride) {
	...
	protected native int sws_scale(@Ptr long c, @Ptr long srcSlice, @Ptr long srcStride, int srcSliceY, int srcSliceH, @Ptr long dst, @Ptr long dstStride);
	/**
	 ...
	 * <i>native declaration : ffmpeg_build/include/libswscale/swscale.h:138</i>
	 */
	public int sws_setColorspaceDetails(Pointer<SwscaleLibrary.SwsContext > c, Pointer<Integer > inv_table, int srcRange, Pointer<Integer > table, int dstRange, int brightness, int contrast, int saturation) {
	...
	protected native int sws_setColorspaceDetails(@Ptr long c, @Ptr long inv_table, int srcRange, @Ptr long table, int dstRange, int brightness, int contrast, int saturation);
	/**
	 * @return -1 if not supported<br>
	 * Original signature : <code>int sws_getColorspaceDetails(SwsContext*, int**, int*, int**, int*, int*, int*, int*)</code><br>
	 * <i>native declaration : ffmpeg_build/include/libswscale/swscale.h:143</i>
	 */
	public int sws_getColorspaceDetails(Pointer<SwscaleLibrary.SwsContext > c, Pointer<Pointer<Integer > > inv_table, Pointer<Integer > srcRange, Pointer<Pointer<Integer > > table, Pointer<Integer > dstRange, Pointer<Integer > brightness, Pointer<Integer > contrast, Pointer<Integer > saturation) {
	...
	protected native int sws_getColorspaceDetails(@Ptr long c, @Ptr long inv_table, @Ptr long srcRange, @Ptr long table, @Ptr long dstRange, @Ptr long brightness, @Ptr long contrast, @Ptr long saturation);
	/**
	 ...
	 * <i>native declaration : ffmpeg_build/include/libswscale/swscale.h:148</i>
	 */
	public Pointer<SwsVector > sws_allocVec(int length) {
		return (Pointer)Pointer.pointerToAddress(sws_allocVec$2(length), SwsVector.class);
	}
	@Ptr 
	@Name("sws_allocVec") 
	protected native long sws_allocVec$2(int length);
	/**
	 ...
	 * <i>native declaration : ffmpeg_build/include/libswscale/swscale.h:154</i>
	 */
	public Pointer<SwsVector > sws_getGaussianVec(double variance, double quality) {
		return (Pointer)Pointer.pointerToAddress(sws_getGaussianVec$2(variance, quality), SwsVector.class);
	}
	@Ptr 
	@Name("sws_getGaussianVec") 
	protected native long sws_getGaussianVec$2(double variance, double quality);
	/**
	 ...
	 * <i>native declaration : ffmpeg_build/include/libswscale/swscale.h:160</i>
	 */
	public Pointer<SwsVector > sws_getConstVec(double c, int length) {
		return (Pointer)Pointer.pointerToAddress(sws_getConstVec$2(c, length), SwsVector.class);
	}
	@Ptr 
	@Name("sws_getConstVec") 
	protected native long sws_getConstVec$2(double c, int length);
	/**
	 ...
	 * <i>native declaration : ffmpeg_build/include/libswscale/swscale.h:166</i>
	 */
	public Pointer<SwsVector > sws_getIdentityVec() {
		return (Pointer)Pointer.pointerToAddress(sws_getIdentityVec$2(), SwsVector.class);
	}
	@Ptr 
	@Name("sws_getIdentityVec") 
	protected native long sws_getIdentityVec$2();
	/**
	 * Scale all the coefficients of a by the scalar value.<br>
	 * Original signature : <code>void sws_scaleVec(SwsVector*, double)</code><br>
	 * <i>native declaration : ffmpeg_build/include/libswscale/swscale.h:171</i>
	 */
	public void sws_scaleVec(Pointer<SwsVector > a, double scalar) {
		sws_scaleVec(Pointer.getPeer(a), scalar);
	}
	protected native void sws_scaleVec(@Ptr long a, double scalar);
	/**
	 ...
	 * <i>native declaration : ffmpeg_build/include/libswscale/swscale.h:176</i>
	 */
	public void sws_normalizeVec(Pointer<SwsVector > a, double height) {
		sws_normalizeVec(Pointer.getPeer(a), height);
	}
	protected native void sws_normalizeVec(@Ptr long a, double height);
	/**
	 * Original signature : <code>void sws_convVec(SwsVector*, SwsVector*)</code><br>
	 * <i>native declaration : ffmpeg_build/include/libswscale/swscale.h:178</i>
	 */
	public void sws_convVec(Pointer<SwsVector > a, Pointer<SwsVector > b) {
		sws_convVec(Pointer.getPeer(a), Pointer.getPeer(b));
	}
	protected native void sws_convVec(@Ptr long a, @Ptr long b);
	/**
	 * Original signature : <code>void sws_addVec(SwsVector*, SwsVector*)</code><br>
	 * <i>native declaration : ffmpeg_build/include/libswscale/swscale.h:180</i>
	 */
	public void sws_addVec(Pointer<SwsVector > a, Pointer<SwsVector > b) {
		sws_addVec(Pointer.getPeer(a), Pointer.getPeer(b));
	}
	protected native void sws_addVec(@Ptr long a, @Ptr long b);
	/**
	 * Original signature : <code>void sws_subVec(SwsVector*, SwsVector*)</code><br>
	 * <i>native declaration : ffmpeg_build/include/libswscale/swscale.h:182</i>
	 */
	public void sws_subVec(Pointer<SwsVector > a, Pointer<SwsVector > b) {
		sws_subVec(Pointer.getPeer(a), Pointer.getPeer(b));
	}
	protected native void sws_subVec(@Ptr long a, @Ptr long b);
	/**
	 * Original signature : <code>void sws_shiftVec(SwsVector*, int)</code><br>
	 * <i>native declaration : ffmpeg_build/include/libswscale/swscale.h:184</i>
	 */
	public void sws_shiftVec(Pointer<SwsVector > a, int shift) {
		sws_shiftVec(Pointer.getPeer(a), shift);
	}
	protected native void sws_shiftVec(@Ptr long a, int shift);
	/**
	 ...
	 * <i>native declaration : ffmpeg_build/include/libswscale/swscale.h:190</i>
	 */
	public Pointer<SwsVector > sws_cloneVec(Pointer<SwsVector > a) {
		return (Pointer)Pointer.pointerToAddress(sws_cloneVec(Pointer.getPeer(a)), SwsVector.class);
	}
	@Ptr 
	protected native long sws_cloneVec(@Ptr long a);
	/**
	 ...
	 * <i>native declaration : ffmpeg_build/include/libswscale/swscale.h:196</i>
	 */
	public void sws_printVec2(Pointer<SwsVector > a, Pointer<AVClass > log_ctx, int log_level) {
		sws_printVec2(Pointer.getPeer(a), Pointer.getPeer(log_ctx), log_level);
	}
	protected native void sws_printVec2(@Ptr long a, @Ptr long log_ctx, int log_level);
	/**
	 * Original signature : <code>void sws_freeVec(SwsVector*)</code><br>
	 * <i>native declaration : ffmpeg_build/include/libswscale/swscale.h:198</i>
	 */
	public void sws_freeVec(Pointer<SwsVector > a) {
		sws_freeVec(Pointer.getPeer(a));
	}
	protected native void sws_freeVec(@Ptr long a);
	/**
	 * Original signature : <code>SwsFilter* sws_getDefaultFilter(float, float, float, float, float, float, int)</code><br>
	 * <i>native declaration : ffmpeg_build/include/libswscale/swscale.h:200</i>
	 */
	public Pointer<SwsFilter > sws_getDefaultFilter(float lumaGBlur, float chromaGBlur, float lumaSharpen, float chromaSharpen, float chromaHShift, float chromaVShift, int verbose) {
	...
	protected native long sws_getDefaultFilter$2(float lumaGBlur, float chromaGBlur, float lumaSharpen, float chromaSharpen, float chromaHShift, float chromaVShift, int verbose);
	/**
	 * Original signature : <code>void sws_freeFilter(SwsFilter*)</code><br>
	 * <i>native declaration : ffmpeg_build/include/libswscale/swscale.h:202</i>
	 */
	public void sws_freeFilter(Pointer<SwsFilter > filter) {
		sws_freeFilter(Pointer.getPeer(filter));
	}
	protected native void sws_freeFilter(@Ptr long filter);
	/**
	 ...
	 * <i>native declaration : ffmpeg_build/include/libswscale/swscale.h:214</i>
	 */
	public Pointer<SwscaleLibrary.SwsContext > sws_getCachedContext(Pointer<SwscaleLibrary.SwsContext > context, int srcW, int srcH, IntValuedEnum<AVPixelFormat > srcFormat, int dstW, int dstH, IntValuedEnum<AVPixelFormat > dstFormat, int flags, Pointer<SwsFilter > srcFilter, Pointer<SwsFilter > dstFilter, Pointer<Double > param) {
		return (Pointer)Pointer.pointerToAddress(sws_getCachedContext(Pointer.getPeer(context), srcW, srcH, (int)srcFormat.value(), dstW, dstH, (int)dstFormat.value(), flags, Pointer.getPeer(srcFilter), Pointer.getPeer(dstFilter), Pointer.getPeer(param)), SwscaleLibrary.SwsContext.class);
	}
	@Ptr 
	protected native long sws_getCachedContext(@Ptr long context, int srcW, int srcH, int srcFormat, int dstW, int dstH, int dstFormat, int flags, @Ptr long srcFilter, @Ptr long dstFilter, @Ptr long param);
	/**
	 ...
	 * <i>native declaration : ffmpeg_build/include/libswscale/swscale.h:224</i>
	 */
	public void sws_convertPalette8ToPacked32(Pointer<Byte > src, Pointer<Byte > dst, int num_pixels, Pointer<Byte > palette) {
		sws_convertPalette8ToPacked32(Pointer.getPeer(src), Pointer.getPeer(dst), num_pixels, Pointer.getPeer(palette));
	}
	protected native void sws_convertPalette8ToPacked32(@Ptr long src, @Ptr long dst, int num_pixels, @Ptr long palette);
	/**
	 ...
	 * <i>native declaration : ffmpeg_build/include/libswscale/swscale.h:234</i>
	 */
	public void sws_convertPalette8ToPacked24(Pointer<Byte > src, Pointer<Byte > dst, int num_pixels, Pointer<Byte > palette) {
		sws_convertPalette8ToPacked24(Pointer.getPeer(src), Pointer.getPeer(dst), num_pixels, Pointer.getPeer(palette));
	}
	protected native void sws_convertPalette8ToPacked24(@Ptr long src, @Ptr long dst, int num_pixels, @Ptr long palette);
	/**
	 ...
	 * <i>native declaration : ffmpeg_build/include/libswscale/swscale.h:241</i>
	 */
	public Pointer<AVClass > sws_get_class() {
		return (Pointer)Pointer.pointerToAddress(sws_get_class$2(), AVClass.class);
	}
	@Ptr 
	@Name("sws_get_class") 
	protected native long sws_get_class$2();
	/** Undefined type */
