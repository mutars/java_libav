...
import com.mutar.libav.bridge.avcodec.AvcodecLibrary.AVAudioServiceType;
import com.mutar.libav.bridge.avcodec.AvcodecLibrary.AVCodecID;
import com.mutar.libav.bridge.avcodec.AvcodecLibrary.AVCodecInternal;
import com.mutar.libav.bridge.avcodec.AvcodecLibrary.AVDiscard;
import com.mutar.libav.bridge.avcodec.AvcodecLibrary.AVFieldOrder;
...
import com.mutar.libav.bridge.avutil.AvutilLibrary.AVColorPrimaries;
import com.mutar.libav.bridge.avutil.AvutilLibrary.AVColorRange;
import com.mutar.libav.bridge.avutil.AvutilLibrary.AVColorSpace;
import com.mutar.libav.bridge.avutil.AvutilLibrary.AVColorTransferCharacteristic;
...
/**
 * <i>native declaration : ffmpeg_build/include/libavcodec/avcodec.h:871</i><br>
...
public class AVCodecContext extends StructObject {
	...
	/** <i>native declaration : ffmpeg_build/include/libavcodec/avcodec.h:833</i> */
	...
	/** <i>native declaration : ffmpeg_build/include/libavcodec/avcodec.h:838</i> */
	public static abstract class get_format_callback extends Callback<get_format_callback > {
		public IntValuedEnum<AVPixelFormat > apply(Pointer<AVCodecContext > s, Pointer<IntValuedEnum<AVPixelFormat > > fmt) {
		...
		public int apply(@Ptr long s, @Ptr long fmt) {
			return (int)apply((Pointer)Pointer.pointerToAddress(s, AVCodecContext.class), (Pointer)Pointer.pointerToAddress(fmt, DefaultParameterizedType.paramType(IntValuedEnum.class, AVPixelFormat.class))).value();
		}
	};
	/** <i>native declaration : ffmpeg_build/include/libavcodec/avcodec.h:857</i> */
	...
	/** <i>native declaration : ffmpeg_build/include/libavcodec/avcodec.h:858</i> */
	...
	/** <i>native declaration : ffmpeg_build/include/libavcodec/avcodec.h:859</i> */
	...
	/** <i>native declaration : ffmpeg_build/include/libavcodec/avcodec.h:860</i> */
	public static abstract class execute_callback extends Callback<execute_callback > {
		...
		public int apply(@Ptr long c, @Ptr long func, @Ptr long arg2, @Ptr long ret, int count, int size) {
			return apply((Pointer)Pointer.pointerToAddress(c, AVCodecContext.class), (Pointer)Pointer.pointerToAddress(func, AVCodecContext.execute_callback_func_callback.class), Pointer.pointerToAddress(arg2), (Pointer)Pointer.pointerToAddress(ret, Integer.class), count, size);
		}
	};
	/** <i>native declaration : ffmpeg_build/include/libavcodec/avcodec.h:861</i> */
	...
	/** <i>native declaration : ffmpeg_build/include/libavcodec/avcodec.h:862</i> */
	public static abstract class execute2_callback extends Callback<execute2_callback > {
		...
		public int apply(@Ptr long c, @Ptr long func, @Ptr long arg2, @Ptr long ret, int count) {
			return apply((Pointer)Pointer.pointerToAddress(c, AVCodecContext.class), (Pointer)Pointer.pointerToAddress(func, AVCodecContext.execute2_callback_func_callback.class), Pointer.pointerToAddress(arg2), (Pointer)Pointer.pointerToAddress(ret, Integer.class), count);
		}
	};
